...
public class RiwayatTransaksi extends javax.swing.JPanel {
    ...
    private Object[][] getDataPenjualan() throws ParseException {
        try {
            ...
            String tanggalPenuh, tanggalPenuh1;
                String sql = "SELECT id_tr_jual, id_karyawan, nama_karyawan, tanggal FROM transaksi_jual ORDER BY id_tr_jual DESC";
                obj = new Object[trj.getJumlahData("transaksi_jual")][7];
    ...
    private Object[][] getDataPembelian() throws ParseException {
        try {
            ...
            int rows = 0, hari_1 = 0, bulan_1 = -1, tahun_1 = 0;
            String tanggalPenuh, tanggalPenuh1;
            String sql = "SELECT id_tr_beli, id_karyawan, nama_karyawan, tanggal FROM transaksi_beli";
            obj = new Object[trb.getJumlahData("transaksi_beli")][5];
            // mengeksekusi query
...
//        pnlMenu.revalidate();
    ...
    private void initComponents() {
        ...
        add(lpSemua, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 1120, 525));
